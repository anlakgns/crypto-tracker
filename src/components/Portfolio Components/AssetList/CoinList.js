...
export const CoinList = (props) => {
  ...
  const { totalSpentByCoin, portfolioList, setSelectedCoinForGraph } =
  ...
  useEffect(() => {
    ...
    switch (tabValue) {
      case 0:
        sortedList = !sort
          ? renderList.sort((a, b) => b.allInfo.price - a.allInfo.price)
          : renderList.sort((a, b) => a.allInfo.price - b.allInfo.price);
        break;
      case 1:
        sortedList = !sort
          ? renderList.sort((a, b) => b.value - a.value)
          : renderList.sort((a, b) => a.value - b.value);
        break;
      case 2:
        sortedList = !sort
          ? portfolioList.sort((a, b) => b.profit - a.profit)
          : portfolioList.sort((a, b) => a.profit - b.value);
        break;
      default:
